...
namespace beecom
{
    ...
    private:
        ...
        void handleWaitingForSOP(uint8_t byte);
        void handleWaitingForType(uint8_t byte);
        void handleWaitingForLength(uint8_t byte);
        void handleWaitingForCRCLow(uint8_t byte);
        void handleWaitingForCRCHigh(uint8_t byte);
